...
class SlugaEngine:
    ...
    async def _chat_completion_with_fallback(self, messages: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        error_guide = (
            "Не настроены API ключи или все провайдеры временно недоступны!\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "💡 ЧТО ДЕЛАТЬ В ЭТОЙ СИТУАЦИИ:\n\n"
            "• Вариант 1: Повторить запрос через 15–30 секунд\n"
            "  Всплески нагрузки на серверах Google AI Studio (503 Service Unavailable) кратковременные.\n"
            "  Просто напишите в терминал любое сообщение еще раз (например: 'привет' или 'покажи статус').\n\n"
            "• Вариант 2: Переключиться на gemini-3.6-flash (отвечает мгновенно без перегрузок)\n"
            "  Смените модель на лету прямо в чате: /model gemini-3.6-flash\n"
            "  Либо в файле .env укажите: GOOGLE_GEMINI_MODEL=gemini-3.6-flash\n"
            "  (Модель gemini-3.6-flash практически никогда не бывает перегружена и работает без задержек).\n\n"
            "• Вариант 3: Использовать LiteAI — Рекомендуемый для боевой работы (https://liteai.tech/)\n"
            "  Для круглосуточной стабильности без лимитов и очередей подключите LiteAI (Claude Sonnet 4.6 / GPT-5.5):\n"
            "  Введите в чате команду: /key liteai <твой_ключ_liteai>\n"
            "  Либо пропишите в файле .env: LITEAI_API_KEY=твой_ключ_liteai\n\n"
            "🕹️ КОМАНДЫ ДЛЯ СМЕНЫ НАСТРОЕК НА ХОДУ (БЕЗ ПЕРЕЗАПУСКА):\n"
            "  • /key liteai sk-bf-...      — установить / сменить ключ сервиса LiteAI\n"
            "  • /key google AIzaSy...      — установить / сменить ключ Google AI Studio\n"
            "  • /model <имя_модели>        — переключить модель (claude-sonnet-4-6, gemini-3.6-flash, GPT-5.5)\n"
            "  • /keys                      — посмотреть текущие активные ключи и модели\n"
            "  • /setup                     — перезапустить интерактивный мастер настройки\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
        )
        raise ValueError(error_guide)
